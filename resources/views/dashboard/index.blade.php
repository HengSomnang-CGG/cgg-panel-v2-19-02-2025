                                ...
                                <div class="bg-gradient-info border-radius-lg h-100">
                                    ...
                                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                        <img class="w-100 position-relative z-index-2 pt-4"
                                            src="../assets/img/main/rocket-white.png" alt="rocket">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row mt-4">
                ...
                <div class="card z-index-2">
                    <div class="card-body p-3">
                        <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                            <div class="chart">
                                <canvas id="chart-bars" class="chart-canvas" height="170" width="356"
                                    style="display: block; box-sizing: border-box; height: 170px; width: 356px;"></canvas>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <div class="progress w-75">
                                        <div class="progress-bar bg-dark w-60" role="progressbar" aria-label="Progress 60%" aria-valuenow="60"
                                ...
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <div class="progress w-75">
                                        <div class="progress-bar bg-dark w-90" role="progressbar" aria-valuenow="90"
                                            aria-valuemin="0" aria-valuemax="100"  aria-label="Progress 90%"></div>
                                    </div>
                                </div>
                                <div class="col-3 py-3 ps-0">
                                    <div class="d-flex mb-2">
                                    ...
                                    <div class="progress w-75">
                                        <div class="progress-bar bg-dark w-30" role="progressbar" aria-valuenow="30"
                                            aria-valuemin="0" aria-valuemax="100" aria-label="Progress 30%"></div>
                                    </div>
                                </div>
                                <div class="col-3 py-3 ps-0">
                                    <div class="d-flex mb-2">
            ...
            <div class="col-lg-7">
                <div class="card z-index-2">
                    ...
                    <div class="card-body p-3">
                        <div class="chart">
                            <canvas id="chart-line" class="chart-canvas" height="300" width="360"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-5 my-auto text-end">
                                <div class="dropdown float-lg-end pe-4">
                                    <a class="cursor-pointer" id="dropdownTable" role="button" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="progress-wrapper w-75 mx-auto">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-info w-60" role="progressbar" aria-label="Progress 60%"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="../assets/img/logos/small-logos/logo-atlassian.svg"
                                        ...
                                        <td class="align-middle">
                                            <div class="progress-wrapper w-75 mx-auto">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-info w-10" role="progressbar" aria-label="Progress 10%"
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="progress-wrapper w-75 mx-auto">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-success w-100" role="progressbar" aria-label="Progress 100%"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="../assets/img/logos/small-logos/logo-jira.svg"
                                        ...
                                        <td class="align-middle">
                                            <div class="progress-wrapper w-75 mx-auto">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-info w-25" role="progressbar"  aria-label="Progress 25%"
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="progress-wrapper w-75 mx-auto">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-info w-40" role="progressbar"  aria-label="Progress 40%"
